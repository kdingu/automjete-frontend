            ...
            <Container>
                ...
                <div className="grid grid-cols-12 mt-10 gap-10">
                    <div className="col-span-12 md:col-span-4 lg:col-span-3">
                        ...
                        <ul>
                            <li>
                                <Button variant="text" className="mt-4 text-xs text-gray-700 hover:text-gray-700"
                                        onClick={handleOpenCookiesManager}>
                                    Cookie manager
                                </Button>
                            </li>
                        </ul>
                    ...
                    <div className="col-span-12 lg:col-span-4">
                        ...
                        <div className="text-xs text-gray-500 mt-4">
                            ...
                            <p>
                                Auto Trader Limited is authorised and regulated by the Financial Conduct Authority in
                                relation to
                                consumer
                                credit and insurance mediation activities. Our FCA firm reference number is 735711. Auto
                                Trader Limited
                                is
                                a credit broker and not a lender. Representative finance examples are for illustrative
                                purposes only.
                                Finance is subject to status. Terms and conditions apply. Available to 18s and over. UK
                                residents only.
                                Auto Trader receives a fee from retailers advertising finance and may receive a
                                commission from
                                commercial
                                partners for introducing customers to finance products. These fees and commissions do
                                not influence the
