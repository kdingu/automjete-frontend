                                            ...
                                            <div className="flex gap-1 justify-between">
                                                ...
                                                {imageList.length > 0 && (
                                                    ...
                                                    >
                                                        ...
                                                        <SvgIcon name="close"
                                                                 className="group-hover:fill-red-400 transition"/>
                                                    </button>
                                                )}
                                            </div>
                                ...
                                {attributeGroups.map((group, index, arr) => {
                                    return (
                                        <Card key={group} title={group}
                                              className={`pt-10 ${index === arr.length - 1 ? "" : "mb-10"}`}>
                                            {groupedAttributes[group].map((attr, index, arr) => (
                                                <Card key={attr.id} title={attr.label}
                                                      className={index === arr.length - 1 ? "" : "mb-10"}>
