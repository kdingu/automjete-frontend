            ...
            <div className="h-full w-7/12">
                <div className="mb-4 p-2">
                    ...
                    <p className="mb-2 mt-4 text-sm">
                        <span
                            className="mb-2 h-2.5 block w-full animate-pulse rounded-full bg-gray-200 dark:bg-gray-700"></span>
                        <span
                            className="mb-2 h-2.5 block w-full animate-pulse rounded-full bg-gray-200 dark:bg-gray-700"></span>
                        <span
                            className="mb-2 h-2.5 block w-full animate-pulse rounded-full bg-gray-200 dark:bg-gray-700"></span>
                        <span
                            className="mb-2 h-2.5 block w-full animate-pulse rounded-full bg-gray-200 dark:bg-gray-700"></span>
                        <span
                            className="h-2.5 w-80 block animate-pulse rounded-full bg-gray-200 dark:bg-gray-700"></span>
                    </p>
                    <div className="text-sm font-bold">
                        <div
                            className="mr-2 inline-block h-2.5 w-20 animate-pulse rounded-full bg-gray-200 dark:bg-gray-700"></div>
                        <div
                            className="mr-2 inline-block h-2.5 w-20 animate-pulse rounded-full bg-gray-200 dark:bg-gray-700"></div>
                        <div
                            className="inline-block h-2.5 w-20 animate-pulse rounded-full bg-gray-200 dark:bg-gray-700"></div>
                    </div>
                </div>
