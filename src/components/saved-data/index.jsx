                            ...
                            {data.map((item, index) => {
                                return (
                                    <div key={item.title + index} className="md:w-1/2 w-full inline-block mb-10">
                                        <div className={`border rounded border-gray-300 cursor-pointer transition-all ease-in-out duration-[250ms] shadow hover:-translate-y-0.5 hover:shadow-md ${index%2 === 0 ? 'md:mr-4' : 'md:ml-4'}`}>
                                            <SavedVehicleCard
                                                vehicle={item}
