          ...
          <div className="grid gap-10 lg:grid-cols-3">
            ...
            <div>
              <div className="flex justify-between">
                ...
                {getIsOpenNow() && <Tag variant="success" className="text-white !text-sm bg-green-600">Open now</Tag>}
              </div>
              ...
              <ul className="mt-4">
                {weekDays.map(day => {
                  ...
                  return (
                    <li key={day} className={`flex justify-between mb-2 ${isToday ? "underline font-bold" : ""}`}>
                      <span>{t(day)}</span>
          ...
          <div className="flex flex-col lg:flex-row gap-10">
            ...
            <form className="lg:w-7/12" onSubmit={contactForm.handleSubmit}>
              ...
              <div className="flex flex-col lg:flex-row gap-3 my-4">
                ...
                <TextInput label="Email" placeholder="e.g. Fisteku" name="email" value={contactForm.values.email}
              ...
              <div className="flex flex-col lg:flex-row gap-3 my-4">
                <Select data={contactMethodOptions}
                        ...
                        placeholder="e.g. 069 69 69 699" name="contactMethod" value={contactForm.values.contactMethod}
                        onChange={contactForm.handleChange} />
                <Select data={contactTimeOptions}
                        label="Prefered contact time" placeholder="e.g. 069 69 69 699" name="contactTime"
              ...
              <p className="mt-4">Auto Trader will use your details in accordance with our privacy policy. In
                addition,
                by hitting &quot;Send your enquiry&quot;, you&apos;re happy for us to pass your details to the seller
                which will be used by the seller in accordance with their privacy policy. Please check the
                seller&apos;s
                website or contact them separately for details.</p>

              <div className="flex flex-col lg:flex-row gap-4 mt-4 lg:gap-0 lg:mt-0 justify-between items-center">
